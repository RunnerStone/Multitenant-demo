...
public class WebSecurityConfig extends ResourceServerConfigurerAdapter {
    ...
    private static final String XSAPPNAME = "multitenancy-mongodb-i317067";
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers(POST, "/api/v1/customer/**").access(hasScopeUpdate)
                .antMatchers(PUT, "/api/v1/customer/**").access(hasScopeUpdate)
                .antMatchers(DELETE, "/api/v1/customer/**").access(hasScopeUpdate)
                .antMatchers(GET, "/api/v1/customer/**").access(hasScopeDisplay)
                .antMatchers(GET, "/**").permitAll(); // deny anything not configured above
        // @formatter:on
    }
